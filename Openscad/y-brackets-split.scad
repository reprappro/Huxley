...
module idler_split1()
{
	difference()
	{
		...
		#translate([-55,-10,7.6]) cube([60,40,10]);
	}
}
module idler_split2()
{
	translate([0,0,0]) difference()
	{
		...
		difference(){
			...
			#translate([-5,-10,7.6]) cube([60,40,10]);
		}
	}
}
module motor_split1()
{
	difference()
	{
		...
		difference(){
			translate([-35,-55,3.5]) cube([100,100,20]);
			#translate([37.05+14,-11,3.5]) cylinder(r=11,h=3);
		}
	}
}
module motor_split2()
{
	translate([0,0,0]) difference()
	{
		...
		#translate([-37.05-15,-11,9]) cylinder(r=11,h=3);
		difference(){
			translate([-65,-55,14-3.5]) cube([100,100,10.5]);
			translate([-37.05-14,-12,3.5]) cylinder(r=11,h=3);
		}
	}
}
